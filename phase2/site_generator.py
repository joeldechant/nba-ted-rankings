    ...
    function goatSort(table, mode) {{
      ...
      if (mode === 'diff' || mode === 'diff-player') {{
        if (goatTextOpen) {{
          ...
          var goatMsg = mode === 'diff-player'
            ? 'Watch out for the herd of GOATs above!'
            : 'Click <span style="font-weight:700;font-style:normal;color:#ee7623">PLAYER</span> above to sort the top 30 DIFF seasons and see the GOAT candidates!';
          textRow.innerHTML = '<td colspan="5" style="text-align:center;padding:12px 16px;cursor:pointer;border:none;background:#000"><p style="font-family:Georgia,serif;font-size:0.85em;font-style:italic;color:#ee7623;margin:0;min-height:2.4em;display:flex;align-items:center;justify-content:center">' + goatMsg + '</p></td>';
          if (mode === 'diff') {{
    ...
    function g2Sort(table, mode) {{
      ...
      if (mode === 'diff' || mode === 'diff-player') {{
        if (g2TextOpen) {{
          ...
          var g2Msg = mode === 'diff-player'
            ? 'Watch out for the herd of GOATs above!'
            : 'Click <span style="font-weight:700;font-style:normal;color:#ee7623">PLAYER</span> above to sort the top 40 DIFF seasons and see the GOAT candidates!';
          textRow.innerHTML = '<td colspan="5" style="text-align:center;padding:12px 16px;cursor:pointer;border:none;background:#000"><p style="font-family:Georgia,serif;font-size:0.85em;font-style:italic;color:#ee7623;margin:0;min-height:2.4em;display:flex;align-items:center;justify-content:center">' + g2Msg + '</p></td>';
          if (mode === 'diff') {{
    ...
    function g3Sort(table, mode) {{
      ...
      if (mode === 'diff' || mode === 'diff-player') {{
        if (g3TextOpen) {{
          ...
          var g3Msg = mode === 'diff-player'
            ? 'Watch out for the herd of GOATs above!'
            : 'Click <span style="font-weight:700;font-style:normal;color:#ee7623">PLAYER</span> above to sort the top 50 DIFF seasons and see the GOAT candidates!';
          textRow.innerHTML = '<td colspan="5" style="text-align:center;padding:12px 16px;cursor:pointer;border:none;background:#000"><p style="font-family:Georgia,serif;font-size:0.85em;font-style:italic;color:#ee7623;margin:0;min-height:2.4em;display:flex;align-items:center;justify-content:center">' + g3Msg + '</p></td>';
          if (mode === 'diff') {{
